...
def make(snap, cs, title_suffix=""):
    # An SVI fit extrapolates its own arbitrage-free wings (see model.curve_vol), so the density
    # is smooth with no ±3-SD kink; the manual wing sliders only affect the polynomial fallback.
